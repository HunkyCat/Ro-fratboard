(() => {
  ...
  function buildRiffBank() {
    ...
    const templates = [
      { name: "Doom Gate Crawl", bpm: 84, steps: [N(6, 0, 0.34, true, false), N(6, 3, 0.34, false, false), N(6, 5, 0.42, true, false), R(0.12), N(5, 5, 0.32, false, false), N(6, 1, 0.36, true, false), N(6, 0, 0.46, true, false)] },
      { name: "Doom Phobos March", bpm: 96, steps: [N(6, 0, 0.26, true, false), N(6, 0, 0.22, false, true), N(6, 3, 0.3, true, false), N(6, 2, 0.22, false, false), N(6, 5, 0.34, true, false), R(0.1), N(5, 5, 0.28, false, false), N(6, 0, 0.34, true, false)] },
      { name: "Puppet Downpick", bpm: 212, steps: [N(6, 0, 0.09, true), N(6, 0, 0.09), N(6, 0, 0.09), N(6, 0, 0.09), N(6, 3, 0.18, true), N(6, 0, 0.09), N(6, 0, 0.09), N(6, 5, 0.2, true), N(5, 5, 0.18), N(6, 3, 0.18), R(0.08)] },
      { name: "Puppet Gallop", bpm: 198, steps: [N(6, 0, 0.1, true), N(6, 0, 0.1), N(6, 3, 0.16, true), N(6, 0, 0.1), N(6, 0, 0.1), N(6, 5, 0.18, true), N(6, 0, 0.1), N(5, 3, 0.16, false, false), N(5, 5, 0.16, false, false), N(6, 0, 0.22, true)] },
      { name: "Puppet Bridge Rush", bpm: 186, steps: [N(6, 0, 0.12, true), N(6, 3, 0.12), N(6, 5, 0.12), N(5, 3, 0.14, false, false), N(5, 5, 0.14, false, false), N(6, 0, 0.12, true), N(6, 3, 0.12), N(6, 0, 0.12, true), N(6, 1, 0.16, false, false), N(6, 0, 0.2, true)] },
      { name: "Rust Holy Drive", bpm: 178, steps: [N(6, 0, 0.12, true), N(5, 2, 0.12, false, false), N(5, 3, 0.12, false, false), N(5, 5, 0.14, true, false), N(4, 2, 0.12, false, false), N(4, 4, 0.12, false, false), N(5, 5, 0.16, true, false), N(6, 0, 0.16, true), N(5, 3, 0.16, false, false), N(6, 3, 0.2, true)] },
      { name: "Rust Tornado Climb", bpm: 192, steps: [N(6, 0, 0.1, true), N(5, 2, 0.1, false, false), N(5, 3, 0.1, false, false), N(5, 5, 0.1, false, false), N(4, 2, 0.1, false, false), N(4, 4, 0.1, false, false), N(4, 5, 0.12, true, false), N(5, 3, 0.1, false, false), N(6, 0, 0.14, true), R(0.08)] },
      { name: "Rust Harmonic Bite", bpm: 172, steps: [N(6, 0, 0.14, true), N(6, 1, 0.14, false, false), N(6, 4, 0.16, true, false), N(5, 3, 0.16, false, false), N(5, 6, 0.18, true, false), N(4, 5, 0.16, false, false), N(5, 3, 0.16, false, false), N(6, 1, 0.16, false, false), N(6, 0, 0.22, true)] },
      { name: "Hybrid Thrash 1990", bpm: 182, steps: [N(6, 0, 0.11, true), N(6, 0, 0.11), N(6, 3, 0.16, true), N(5, 2, 0.12, false, false), N(5, 5, 0.16, true, false), N(6, 0, 0.11, true), N(6, 5, 0.16, true), N(5, 3, 0.14, false, false), N(6, 1, 0.16, false, false), N(6, 0, 0.2, true)] },
      { name: "Old School Outro", bpm: 110, steps: [N(6, 0, 0.24, true, false), N(6, 0, 0.24, false, true), N(6, 3, 0.3, true, false), N(5, 5, 0.32, false, false), N(6, 5, 0.3, true, false), N(6, 3, 0.26, false, false), N(6, 1, 0.26, false, false), N(6, 0, 0.42, true, false)] },
    ];
